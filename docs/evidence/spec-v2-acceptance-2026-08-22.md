...
- Repository source: `dfe18e23746903508ac616b93fc3d0d612f63367` is pushed to `origin/main`.
...
- Exact-SHA release: `/opt/teratts/releases/dfe18e23746903508ac616b93fc3d0d612f63367`.
- Binary SHA-256: `c8f91740ca5eea577a7c4a3a99e2cced19526df16dd61b1ce5c2b263a39485f9`.
...
- Admission/resource contract: one active plus two waiting is covered by unit tests; predicted duration is rejected before latent allocation; checked/fallible allocations are used.
- Rollback drill: `dfe18e2 -> d62a0fb -> dfe18e2` completed with exact-SHA health checks and final authenticated WAV acceptance.
...
- Twenty-request serial soak and observed RSS ceiling under load.
